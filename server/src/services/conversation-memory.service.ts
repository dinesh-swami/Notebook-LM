...
} from "../repository/conversation.repositry.js";
import { findMessagesByConversationId } from "../repository/message.repositry.js";
...
export async function summarizeConversationById(
  ...
  const recentMessages = messages.slice(-16).map((message: { role: string; content: any; }) => ({
